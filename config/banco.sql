...
CREATE TABLE comentarios (
   ...
   comentario TEXT,
   criado_em TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
   CONSTRAINT fk_coment_produto FOREIGN KEY (produto_id) REFERENCES produtos(idPRODUTO) 
      ON DELETE CASCADE ON UPDATE CASCADE,
   CONSTRAINT fk_coment_usuario FOREIGN KEY (usuario_id) REFERENCES usuarios(idUSUARIO) 
      ON DELETE CASCADE ON UPDATE CASCADE,
   CONSTRAINT fk_coment_pedido FOREIGN KEY (pedido_id) REFERENCES pedidos(idPEDIDO) 
      ON DELETE CASCADE ON UPDATE CASCADE
